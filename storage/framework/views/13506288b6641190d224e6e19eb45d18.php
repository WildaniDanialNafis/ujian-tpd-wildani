    ...
    <div class="px-3 px-md-4">
                    ...
                    <table class="table table-bordered table-hover align-middle mb-0" id="kategoriTable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="fw-medium"><?php echo e($k->id_kategori); ?></td>
                                    <td><?php echo e($k->nama_kategori); ?></td>
                                    <td class="text-muted"><?php echo e($k->keterangan ?? '—'); ?></td>
                                    <td>
                                        <div class="d-flex gap-2">
                                            <form id="deleteForm<?php echo e($k->id_kategori); ?>"
                                                action="<?php echo e(route('kategori.destroy', $k->id_kategori)); ?>" method="POST"
                                                style="display:none;">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                            </form>
                                            <button class="btn btn-sm btn-danger delete-btn" data-id="<?php echo e($k->id_kategori); ?>"
                                                data-nama="<?php echo e($k->nama_kategori); ?>">
                                                <i class="fas fa-trash me-1"></i> Hapus
                                            </button>
                                            <button class="btn btn-sm btn-primary"
                                                onclick="window.location.href='<?php echo e(route('kategori.edit', $k->id_kategori)); ?>'">
        ...
        <div class="mt-3">
            <button id="btnTambah" class="btn btn-success d-flex align-items-center gap-2 px-4 py-2"
                onclick="window.location.href='<?php echo e(route('kategori.create')); ?>'">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/ujian-tpd-wildani/resources/views/kategori/index.blade.php ENDPATH**/ ?>